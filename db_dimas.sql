...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Nov 2017 pada 05.11
...
(1, 'Universitas Negeri Jakarta', '<p>Jl. Rawamangun Muka, Jakarta Timur, Kota Jakarta, Daerah Khusus Ibukota Jakarta 13220 \r\n<p>Telp. (021) 4890046', 'Drs. Makmuri, M.Si', '19640715 198903 1 006', 'logo.png');

-- --------------------------------------------------------

--
-- Struktur dari tabel `t_acara`
--

CREATE TABLE `t_acara` (
  `id_acara` int(3) NOT NULL,
  `nama_acara` varchar(50) NOT NULL,
  `ketua_acara` varchar(75) NOT NULL,
  `jenis_acara` varchar(20) NOT NULL,
  `tanggal_acara` date NOT NULL,
  `tempat` varchar(100) NOT NULL,
  `dana_diajukan` int(10) NOT NULL,
  `dana_disetujui` int(10) NOT NULL,
  `file_pdf` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `t_acara`
--

INSERT INTO `t_acara` (`id_acara`, `nama_acara`, `ketua_acara`, `jenis_acara`, `tanggal_acara`, `tempat`, `dana_diajukan`, `dana_disetujui`, `file_pdf`) VALUES
(1, 'LDKS', '', 'Kepelatihan', '0000-00-00', '', 0, 0, ''),
(101, 'Pensi', '', 'Entertainment', '2012-10-18', '', 0, 0, '');
...
INSERT INTO `t_admin` (`id`, `username`, `password`, `nama`, `nip`, `level`, `status`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', '19900326 201401 1 002', 'Super Admin', '1'),
(2, 'umum', 'adfab9c56b8b16d6c067f8d3cff8818e', 'Divisi Web', '19900326 201401 1 002', 'Admin', '0'),
(3, 'bemilkom', '61ec00dbabc9c3b671751ee2e6ab8dc7', 'BEM Prodi Ilkom', '1234567890', 'Admin', '0');
...
--
-- Struktur dari tabel `t_profil_organisasi`
--

CREATE TABLE `t_profil_organisasi` (
  `id_organisasi` int(3) NOT NULL,
  `nama_organisasi` varchar(50) NOT NULL,
  `ketua_organisasi` varchar(75) NOT NULL,
  `wakil_ketua` varchar(75) NOT NULL,
  `sekretaris_1` varchar(75) DEFAULT NULL,
  `sekretaris_2` varchar(75) NOT NULL,
  `bendahara_1` varchar(75) NOT NULL,
  `bendahara_2` varchar(75) DEFAULT NULL,
  `divisi_1` varchar(75) DEFAULT NULL,
  `divisi_2` varchar(75) DEFAULT NULL,
  `divisi_3` varchar(75) DEFAULT NULL,
  `logo_organisasi` varchar(50) DEFAULT NULL,
  `struktur_organisasi` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `t_surat_masuk`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=393;COMMIT;
