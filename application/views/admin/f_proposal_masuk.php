...
<div class="navbar navbar-inverse">
	<div class="container">
		<div class="navbar-header">
			<span class="navbar-brand" href="#">Form Pengajuan Proposal</span>
		</div>
	</div><!-- /.container -->
</div><!-- /.navbar -->
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Nama Event</td><td><b><input type="text" name="nama_event" style="width: 400px" class="form-control"></b></td></tr>
		...
		<tr><td width="20%">Keterangan</td><td><b><textarea name="uraian" required style="width: 400px; height: 90px" class="form-control"><?php echo $uraian; ?></textarea></b></td></tr>	
		<tr><td colspan="2">
		<br><button type="submit" class="btn btn-primary" tabindex="10">Kirim</button>
		</td></tr>
		</table>
	</div>
	...
	<div class="col-lg-6">	
		...
		<tr><td width="20%">Tempat Acara</td><td><b><input type="text" name="ket" value="<?php echo $ket; ?>" style="width: 400px" class="form-control"></b></td></tr>	
		</table>	
	</div>
