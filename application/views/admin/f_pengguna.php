<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">	
		<table width="100%" class="table-form">
			<tr><td width="20%">Nama Pimpinan</td><td><b><input type="text" name="ketua_instansi" required value="<?php echo $data->ketua_instansi; ?>" style="width: 300px" class="form-control"></b></td></tr>
			<tr><td width="20%">NIP Pimpinan</td><td><b><input type="text" name="nidn" required value="<?php echo $data->nidn; ?>" style="width: 300px" class="form-control"></b></td></tr>
